...
def header_home():
    ...
    st.markdown(f"""
        <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; margin-bottom: 2.5rem; margin-top: 1rem;">
            ...
            <h1 style='text-align: center; color: #FFFFFF !important; font-size: 3.6rem; font-weight: 800; letter-spacing: -0.03em; margin-top: 18px; line-height: 1.05; text-shadow: 0 4px 20px rgba(0,0,0,0.3);'>
                <span style="color: #FFFFFF !important;">SNAP</span><span style="background: linear-gradient(135deg, #818CF8 0%, #C084FC 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">CLASS</span>
            </h1>
        ...
        <div style="display:flex; align-items:center; gap: 16px; margin-bottom: 0.5rem;">
            ...
            <div>
                <h2 style='text-align:left; font-size: 2rem; font-weight: 800; line-height: 1.0; margin: 0; letter-spacing: -0.02em;'>
                    <span style="color: #4F46E5 !important;">SNAP</span><span style="color: #10B981 !important;">CLASS</span>
                </h2>
