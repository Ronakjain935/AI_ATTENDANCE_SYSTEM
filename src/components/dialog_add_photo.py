...
def add_photos_dialog():
    st.markdown("<p style='color: #475569 !important; font-size: 0.95rem; margin-bottom: 1rem;'>Add classroom photos to scan for student attendance.</p>", unsafe_allow_html=True)
